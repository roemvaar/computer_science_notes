...
When you get a question, try just working through intuitively on a real example. Often a bigger example will be easier.
...
Implement a multi-step approach. First, we simplify or tweak some constraint. Then, we solve this new simplified version
